export const NODES = [
  ...
  { id:'kraftwerk', label:'Kraftwerk', type:'artist', genre:'experimental', era:1970, city:'Düsseldorf', country:'DE',
    desc:'Kraftwerk was formed in Düsseldorf in 1969 by Ralf Hütter and Florian Schneider as part of the West German experimental rock scene. By the mid-1970s they had abandoned guitars entirely and built their own instruments and sequencers, establishing a self-contained studio practice they called the Kling Klang — a private world of machines. Their conceptual framework treated technology as subject matter: Autobahn (1974) is the experience of driving a motorway rendered in synthesizer, Trans-Europe Express (1977) is the continental rail network as music, The Man-Machine (1978) presents the band itself as robots indistinguishable from the technology they operate. Computer World (1981) addressed the coming digital infrastructure with a prescience that seemed prophetic a decade later. The direct route from Kraftwerk to Detroit techno is documented: Juan Atkins heard "Trans-Europe Express" on Detroit\'s black radio station WGPR in the early 1980s and described the impact as foundational. Derrick May famously summarised Detroit techno as "the synthesis of George Clinton and Kraftwerk" — the Afrofuturist tradition of Parliament meeting the machine-aesthetic of Düsseldorf. Afrika Bambaataa sampled "Trans-Europe Express" for "Planet Rock" (1982), producing the electro genre that preceded Detroit techno directly. Kraftwerk are the most important European influence on American electronic music, and through Detroit, on European electronic music\'s subsequent development — a feedback loop that crossed the Atlantic twice.',
    releases: [
  ...
  { id:'chicago_scene', label:'Chicago House', type:'style', genre:'chicago', era:1982, city:'Chicago', country:'US',
    desc:'House music emerged in Chicago in the early 1980s from the specific conditions of Black and Latino queer nightlife on the city\'s South and West Sides, particularly at The Warehouse, where Frankie Knuckles DJed from 1977, and later at The Music Box, where Ron Hardy played. After disco collapsed commercially in 1979, the music and the communities that had built it around it continued in these spaces. DJs extended records using reel-to-reel tape edits, then integrated Roland drum machines — TR-808, then TR-909 — to fill gaps in the sound and drive continuous mixes that no longer needed to stop between tracks. The term "house" derived from The Warehouse. Jesse Saunders and Vince Lawrence pressed the first commercial house record, "On and On", in 1984 on their own Mitchbal Records label — the first time this music existed as a physical commodity rather than as DJed tape edits. Trax Records and DJ International followed, providing infrastructure for Jamie Principle, Larry Heard, Marshall Jefferson, and others. The Roland TB-303 bass synthesizer — a budget instrument designed to accompany guitarists, discontinued in 1984 — was reprogrammed by Phuture (DJ Pierre, Spanky, Herb J) in 1986 in ways that produced an acid, squelching sound its manufacturers had not anticipated. Acid Tracks (1987, Trax Records) defined acid house. House reached the United Kingdom in 1986 via imported twelve-inches and began a transformation of British youth culture that culminated in the Second Summer of Love in 1988 and the rave era. It reached Detroit via WBMX and WGPR radio broadcasts and became one of the two primary inputs — along with Kraftwerk — for what Juan Atkins, Derrick May, and Kevin Saunderson would synthesise into Detroit techno.',
    releases: [
  ...
  { id:'detroit_scene', label:'Detroit Techno', type:'style', genre:'detroit', era:1985, city:'Detroit', country:'US',
    desc:'Detroit techno emerged in the mid-1980s from a precise convergence of people, machines, and circumstance in one American city. Detroit in 1985 is in freefall: the population has halved since 1950, the auto industry has collapsed, the tax base is gone, entire neighbourhoods are being demolished. In this context, three producers who grew up together in Belleville, Michigan — Juan Atkins, Derrick May, and Kevin Saunderson — develop a music that uses the very machines that replaced the workers as its instruments. TR-909 drum machine, Roland synthesizers, tape loops, sequencers: the sonic tools of the assembly line repurposed as artistic materials. They absorbed Kraftwerk\'s machine-aesthetic from radio and import shops; Chicago house\'s rhythmic structures from WBMX broadcasts; Parliament-Funkadelic\'s Afrofuturism from their parents\' record collections. What they produced was none of these things and all of them — a new synthesis that Juan Atkins called "techno" after Alvin Toffler\'s term "techno rebels" in his book The Third Wave. The records they released between 1985 and 1990 — on Metroplex, Transmat, and KMS respectively — defined the genre\'s parameters: sixteen-bar loops, rigid rhythmic grids, synthesizer melodies that expressed alienation and aspiration simultaneously, no vocals. By the early 1990s, Underground Resistance and its extended family (Robert Hood, Drexciya, Galaxy 2 Galaxy) had given the music a political and spiritual dimension that extended its reach further. The European underground discovered the catalogue in the same years and the Detroit–Berlin axis carried it across the Atlantic. Detroit techno is now recognised as one of the most significant forms of popular music to emerge in the United States in the twentieth century.',
    releases: [
  ...
  { id:'belleville3', label:'Belleville Three', type:'artist', genre:'detroit', era:1985, city:'Detroit', country:'US',
    desc:'Juan Atkins, Derrick May, and Kevin Saunderson met as high school students in Belleville, Michigan — a suburb southwest of Detroit — in the late 1970s. They were connected through a shared obsession with electronic music absorbed from multiple directions: Kraftwerk, Parliament-Funkadelic, Giorgio Moroder, and the emergent Chicago house scene broadcast on WBMX radio. A music teacher, Rik Davis, introduced Atkins to synthesizers; Atkins introduced May and Saunderson. Their routes diverged but stayed connected. Atkins formed Cybotron with Davis and released the electro records that established Detroit\'s machine vocabulary: "Alleys of Your Mind" (1981), "Cosmic Cars" (1982), "Clear" (1983). He then founded Metroplex Records in 1985 and recorded alone as Model 500 — "No UFOs" (1985) is among the most cited originating moments in techno history. May founded Transmat in 1986 and recorded as Rhythim Is Rhythim: "Strings of Life" (1987), its cascading piano loop layered over a rigid TR-909 pattern, became one of the most recognisable records ever made in the genre. Saunderson founded KMS Records in 1987 and produced in two registers simultaneously: as E-Dancer, pure industrial techno; as Inner City with vocalist Paris Grey, pop-inflected house tracks ("Big Fun", "Good Life", 1988) that charted across Europe and gave the Belleville Three their widest mainstream audience. The term "Belleville Three" entered common use in the 1990s as a retrospective recognition that these three people, in the same suburb at the same time, had between them invented a new form of music — simultaneously.',
    releases: [
  ...
  { id:'hawtin', label:'Richie Hawtin', type:'artist', genre:'minimal', era:1990, city:'Windsor', country:'CA', spotify:'3AhwIUus3pIaA3CvYBEtpy',
  ...
  { id:'tresor_club', label:'Tresor Club', type:'venue', genre:'techno', era:1991, city:'Berlin', country:'DE',
    desc:'Tresor opened on 18 January 1991 in the vault of the former Wertheim department store on Potsdamer Strasse — one of Berlin\'s great pre-war department stores, bombed in 1943, stranded on the east side of what became the Wall, then abandoned for decades after reunification. Its founder, Dimitri Hegemann, had already been running underground music events in the city for years, and had made direct contact with the Detroit scene before Tresor opened: he had promoted UR\'s first European concert and licensed their catalogue to release in Germany. The vault room itself became legendary — a single narrow doorway, concrete ceiling at head height, original strongroom lockboxes still embedded in the walls, a PA Funktion-One system that operated at extraordinary volume in a space designed to muffle. Jeff Mills was among the first DJs to play there and became a resident. The room functioned as a pressure vessel: the density of the crowd, the low ceiling, and the sound system created physical conditions that are inseparable from the music made for it during this period. Tresor Records launched simultaneously, distributing Detroit records into Europe and signing European acts to record in the Detroit idiom. The original site closed in 2005 when the building was sold for development. A second Tresor opened in 2007 at Köpenicker Strasse 70, built inside a former East German power plant — an entirely different architecture, industrial in a different register, which over time produced a different sound. Tresor\'s contribution is not just as a venue but as an institution that understood the Detroit–Berlin connection as structural rather than coincidental, and built its entire identity around that understanding.' },
  ...
  { id:'berlin_zero_hour', label:'Berlin Zero Hour', type:'moment', genre:'techno', era:1991, city:'Berlin', country:'DE',
    desc:'The Berlin Wall falls on 9 November 1989. Within weeks the eastern half of the city empties its factories and government buildings, leaving entire blocks abandoned in a legal and administrative vacuum that would last years. Squatters and DJs move into the ruins simultaneously. The first wave of parties happens in 1990 in Mitte: UFO in a basement on Chausseestrasse, then Tresor on 18 January 1991, opened by Dimitri Hegemann in the bomb-damaged vault of the former Wertheim department store on Potsdamer Strasse, right on the old border. Hegemann had already made a transatlantic connection — he had promoted the first legal concert by Detroit\'s Underground Resistance in Europe and understood immediately that Detroit\'s post-industrial machine music and the physical wreckage of post-Wall Berlin were made for each other. The vault room — steel lockboxes still embedded in its walls, a single doorway, concrete ceilings — created an acoustic environment that shaped the music played inside it. Jeff Mills was among the first DJs to play there and became a resident. The warehouse techno sound that emerged from Berlin in the early 1990s — harder and more functional than what Detroit had produced, stripped of gospel and soul influence, designed for rooms that went for twelve hours — was the city\'s own synthesis from that encounter. E-Werk, Planet, Ostgut, and eventually Berghain (2004) followed the same logic: occupy the ruins, create the conditions, let the music emerge. Berlin became the global capital of techno not by imitating Detroit but by doing to Detroit\'s records what Detroit had done to Kraftwerk\'s: absorbing them completely and producing something new.' },

  { id:'detroit_berlin_axis', label:'Detroit–Berlin Axis', type:'moment', genre:'techno', era:1992, city:'Detroit', country:'US',
    desc:'The Detroit–Berlin axis is the defining geopolitical fact of electronic music in the 1990s. It begins with a specific transaction: in 1991, Dimitri Hegemann — founder of Tresor — travels to Detroit, licenses the Underground Resistance catalogue, and brings Jeff Mills to Berlin as one of Tresor\'s first resident DJs. Mills flies over and plays the vault. The resonance is immediate and structural: Detroit in 1991 is a city hollowed out by deindustrialisation, its population fallen by half since 1950, entire neighbourhoods abandoned. Berlin in 1991 is a city cut in two for 28 years and suddenly reunified, the eastern half emptied of its institutions overnight. Both cities are post-catastrophe. Both cities have vast empty industrial space and a generation with little to lose. Detroit techno — futurist, machine-made, emotionally severe — lands in Berlin as the sound of exactly that condition. The exchange accelerates: the Tresor II: Berlin–Detroit compilation (1993) formalises the connection with releases from Robert Hood, Blake Baxter, Underground Resistance, and Surgeon on the same double-LP. Jeff Mills records his first solo album, Waveform Transmission Vol. 1 (Tresor, 1992), in Berlin. Robert Hood moves briefly to Germany. UR releases cross to Clone in Rotterdam, to Warp in Sheffield, to Hard Wax in Berlin — which Hegemann had also co-founded — distributing Detroit records into the European underground through a single shop in Kreuzberg that became a de facto embassy. What Berlin gives back is scale, infrastructure, and a legal context: techno parties here can go for two days, in buildings Detroit could never have accessed. By the mid-1990s this feedback loop has produced something neither city could have produced alone — a global underground built on two post-industrial wastelands talking to each other across the Atlantic through twelve-inch records.' },
  ...
  { id:'berghain', label:'Berghain', type:'venue', genre:'techno', era:2004, city:'Berlin', country:'DE',
    desc:'Berghain opened in December 2004 in a former East German heating plant at Am Wriezener Bahnhof in Friedrichshain, co-founded by Michael Teufele and Norbert Thormann. The building was designed in the Brutalist style by architect Rüdiger Gutschow and stands six storeys tall — its industrial scale is integral to the club\'s identity. The main floor is a large concrete room with a Funktion-One sound system, no windows, and near-total darkness; it operates on weekends from Saturday night through to Monday morning. Panorama Bar on the upper floor runs a house and garage programme simultaneously. Berghain has become the most scrutinised door in the world — the bouncers, led for years by Sven Marquardt, a tattooed former East German photographer, apply an unwritten selection with no consistent explanation given. Photographing inside is banned. The club\'s queerness is structural, not decorative: it grew out of Ostgut, a fetish and queer party space. German tax courts ruled in 2016 that Berghain qualifies as a cultural institution — the same legal category as an opera house — entitling it to a reduced VAT rate, a decision that made international news. Its Ostgut Ton label, founded in 2005, documents the aesthetic of both floors through residents Marcel Dettmann, Ben Klock, Len Faki, and others.' },
  ...
  { id:'club_roxy', label:'RoXY', type:'venue', genre:'deep', era:1987, city:'Amsterdam', country:'NL',
    desc:'RoXY opened on Amsterdam\'s Singel in August 1987, co-founded by Eddy de Clercq, artist Peter Giele and Arjen Schrama of music magazine Vinyl. De Clercq served as artistic director and musical programmer from the start, building a reputation for adventurous bookings and theatrical spectacle that made RoXY one of the most internationally recognised clubs in Europe during the late 1980s and 1990s. The club fused house music with performance art, fashion and nightlife in a way that shaped Amsterdam\'s identity as a creative clubbing capital. It closed in 1999 after twelve years. De Clercq received the Gouden Harp that year in recognition of RoXY\'s pioneering role in Dutch dance culture.' },
  ...
  { id:'bluetiek_in', label:'BlueTiek-In', type:'venue', genre:'chicago', era:1983, city:'Rotterdam', country:'NL',
    desc:'BlueTiek-In opened on 20 May 1983 in a former Mercedes-Benz showroom on Rotterdam\'s Karel Doormanstraat, founded by Herman Dikker and Dick Beekman. Rotterdam\'s first superdisco, it held two thousand visitors across two moving dance floors with elaborate light shows and a cinema hall. The venue was early in the Netherlands for hip hop, breakdance and electro. From around 1987 resident DJ Peter Slaghuis became one of the first DJs in the country to play Chicago house to a mainstream Rotterdam crowd, with Paul Elstak beginning his career there the same year. The club sold in 1989, but its role in seeding house music in Rotterdam proved formative for the city\'s subsequent club scene.' },

  { id:'peter_slaghuis', label:'Peter Slaghuis', type:'artist', genre:'chicago', era:1987, city:'Rotterdam', country:'NL',
    desc:'Peter Slaghuis (1961–1991) was born in Rijswijk and began DJing in The Hague area as a teenager, later becoming one of the key figures in introducing Chicago house to the Netherlands alongside Ben Liebrand. At Rotterdam\'s BlueTiek-In he was among the first DJs in the country to play house music to a mainstream crowd. Under the name Hithouse he produced some of the earliest acid-inflected house records released in the Netherlands — "Jack to the Sound of the Underground" reached number eight on the UK Singles Chart in 1988. He founded Hithouse Records and launched the early careers of Paul Elstak and Holy Noise. Slaghuis died in a car crash in 1991 at thirty, on his way home from a gig in Amsterdam.' },
  ...
  { id:'ricky_montanari', label:'Ricky Montanari', type:'artist', genre:'techno', era:1988, city:'Naples', country:'IT',
    desc:'Ricky Montanari is a Naples-born DJ and producer who has been central to the Italian techno scene since the late 1980s. He was the primary resident DJ of Angels of Love, the Neapolitan party that became one of the largest outdoor rave events in Europe, and his long tenure there made him one of the defining figures of the city\'s underground. His sets are characterised by a hard, driving techno rooted in the industrial and Belgian sounds of the early 1990s, filtered through a distinctly Italian intensity. He remains active and is widely respected as a foundational figure in European techno history.',
    releases: [] },
  ...
  // ── MINISTRY OF SOUND ─────────────────────────────────────────────────────
  { id:'ministry_of_sound', label:'Ministry of Sound', type:'venue', genre:'deep', era:1991, city:'London', country:'UK',
  ...
  { id:'congo_natty', label:'Congo Natty', type:'artist', genre:'techno', era:1992, city:'London', country:'UK',
  ...
  { id:'junior_boys_own', label:'Junior Boy\'s Own', type:'label', genre:'deep', era:1992, city:'London', country:'UK',
    desc:'Junior Boy\'s Own was founded in 1992 by Terry Farley and Steve Hall, growing out of the Boy\'s Own fanzine and community that had formed in 1986 around clubbers including Terry Farley, Andrew Weatherall, Cymon Eckel, and Steven Mayes. The earlier Boy\'s Own Recordings imprint (1990–1993) gave way to Junior Boy\'s Own, which became one of the most significant UK house labels of the 1990s — releasing early work by The Chemical Brothers (then Dust Brothers), Underworld, and XPRESS 2. The label occupied the intersection of acid house, techno, and big beat, and was central to documenting the evolution from the acid house explosion of 1988 into the more varied UK club culture of the 1990s.',
    releases: [] },
  ...
  { id:'mcde', label:'Motor City Drum Ensemble', type:'artist', genre:'deep', era:2007, city:'Stuttgart', country:'DE',
    desc:'Motor City Drum Ensemble is the project of Dario Zenker, co-founder (with his brother Marco) of Ilian Tape in Munich. His sound draws a direct line from Detroit deep house and Chicago soul through a distinctly European minimalist lens. Consistently ranked in the RA Top 20 through the mid-2010s, his productions on Ilian Tape, Running Back, and Permanent Vacation helped establish a bridge between Detroit house heritage and the contemporary European underground.',
    releases: [
  ...
  { id:'jamie_jones', label:'Jamie Jones', type:'artist', genre:'house', era:2008, city:'London', country:'UK',
    desc:'Jamie Jones is a Welsh DJ and producer who became one of the defining figures of the Ibiza underground in the 2010s. He co-founded Hot Creations (2011) with Lee Foss and Paradise, the Wednesday night at DC-10 that became the most influential party on the island during that period. His productions fuse Chicago house warmth with techno structure and Balearic influence.',
    releases: [
  ...
  { id:'patrick_topping', label:'Patrick Topping', type:'artist', genre:'house', era:2012, city:'Newcastle', country:'UK',
    desc:'Patrick Topping is a Newcastle-born DJ and producer who emerged through the Hot Creations label after meeting Jamie Jones. He rose rapidly to prominence in the early 2010s, blending house and techno with dub and broken rhythms. His 2014 release "Forget" became one of the decade\'s most played underground house tracks.',
    releases: [
  ...
  { id:'eats_everything', label:'Eats Everything', type:'artist', genre:'house', era:2011, city:'Bristol', country:'UK',
    desc:'Eats Everything (Daniel Pearce) emerged from Bristol in 2011 with a high-energy take on house music drawing on Chicago jackin\' rhythms, acid, and rave energy. His early run on Swamp 81 and Skream\'s Of Unsound Mind made him one of the most in-demand DJs in the UK. He founded Edible Records and is a Ibiza regular, known for marathon party sets.',
    releases: [
  ...
  { id:'donato_dozzy', label:'Donato Dozzy', type:'artist', genre:'techno', era:2006, city:'Rome', country:'IT', bandcamp:'donatodozzy',
    desc:'Donato Dozzy is a Rome-born artist whose music bridges minimal techno, ambient, and psychedelic repetition. His 2008 collaboration with Neel, released as Voices from the Lake, is among the most critically revered techno albums of its era. He runs Spazio Disponibile and has released on Contort, Aquaplano, and K-Records, representing a particularly Italian strand of deep, trance-like electronics.',
    releases: [
  ...
  { id:'scuba', label:'Scuba', type:'artist', genre:'techno', era:2006, city:'London', country:'UK', bandcamp:'scubaofficial',
    desc:'Scuba (Paul Rose) founded Hotflush Recordings in London in 2006, which became one of the most important labels bridging UK bass music, dubstep, and minimal techno. His own productions track that trajectory from deep dubstep into driving techno. He later became a Berghain resident and relocated to Berlin, and Hotflush released key records by Mount Kimbie, Joy Orbison, and George FitzGerald.',
    releases: [
  ...
  { id:'pan_pot', label:'Pan-Pot', type:'artist', genre:'techno', era:2007, city:'Berlin', country:'DE',
    desc:'Pan-Pot is the Berlin duo of Tassilo Ippenberger and Thomas Benedix. They co-founded Second State Records in 2013, which became an important hub for Berlin techno with a harder, more industrial edge than the Berghain sound. Their productions and DJ sets are characterised by driving, layered rhythms and a meticulous approach to tension and release.',
    releases: [
  ...
  { id:'kolsch', label:'Kölsch', type:'artist', genre:'house', era:2012, city:'Copenhagen', country:'DK',
    desc:'Kölsch (Rune Reber) is a Danish producer and DJ who works across melodic house and techno with strong emotional and cinematic qualities. He has released on Kompakt, Fabric, and his own Ipso label, and his album trilogy (1977, 1983, 1989) established his reputation for long-form, autobiographical electronic work.',
    releases: [
  ...
  { id:'levon_vincent', label:'Levon Vincent', type:'artist', genre:'house', era:2008, city:'New York', country:'US', bandcamp:'levonvincent',
    desc:'Levon Vincent is a Brooklyn-based DJ and producer who runs Novel Sound, one of the most respected deep house labels of the 2010s. His productions are rooted in the spiritual and hedonistic traditions of Chicago house and NYC dance music, with a raw, analogue production aesthetic. He is a regular at Berghain and Rex Club.',
    releases: [
  ...
  { id:'george_fitzgerald', label:'George FitzGerald', type:'artist', genre:'house', era:2012, city:'Edinburgh', country:'UK',
    desc:'George FitzGerald is an Edinburgh-born, Berlin-based producer and DJ who emerged through Hotflush Recordings (alongside Scuba and Mount Kimbie). His sound is emotional and melodic, drawing on deep house and UK bass with strong pop sensibility. His debut album Fading Love (2015, Double Six) crossed into mainstream critical recognition while retaining underground credibility.',
    releases: [
  ...
  { id:'dusky', label:'Dusky', type:'artist', genre:'house', era:2012, city:'London', country:'UK',
    desc:'Dusky (Nick Harriman and Alfie Granger-Howell) are a London-based duo who emerged in the early 2010s with a sound bridging UK rave energy, deep house, and melodic techno. Their label 17 Steps released records across this spectrum and their DJ sets — often b2b — are known for emotional range and technical precision. They have played Fabric, DC-10, and Warehouse Project.',
    releases: [
  ...
  { id:'guy_gerber', label:'Guy Gerber', type:'artist', genre:'house', era:2006, city:'Tel Aviv', country:'IL', bandcamp:'guygerber',
    desc:'Guy Gerber is an Israeli DJ and producer who has released on Circus Company and his own Rumors label, which he also runs as a nomadic party series. His productions blend minimal house with a lyrical, melancholic quality distinct in the European techno landscape. His album Intention (2007) on Cocoon remains a reference point for emotional minimal.',
    releases: [
  ...
  { id:'answer_code_request', label:'Answer Code Request', type:'artist', genre:'techno', era:2014, city:'Berlin', country:'DE', bandcamp:'answercoderequest',
    desc:'Answer Code Request (Patrick Gräser) is a Berlin-based DJ and producer who has released on Ostgut Ton, making him part of the Berghain aesthetic lineage. His sound is rooted in dub techno and bass-heavy minimalism and has been documented in his acclaimed Fabric 75 mix (2014). He is one of the most prolific and respected artists in the contemporary Berlin underground.',
    releases: [
  ...
  { id:'hotflush', label:'Hotflush Recordings', type:'label', genre:'house', era:2006, city:'London', country:'UK', bandcamp:'hotflush',
    desc:'Hotflush Recordings was founded in London in 2006 by Scuba (Paul Rose). It began as a deep dubstep and bass music imprint before shifting into minimal techno and deep house, reflecting its founder\'s own musical journey. The label released key early records by Mount Kimbie, Joy Orbison, and George FitzGerald, making it one of the most influential UK underground labels of its era.',
    releases: [
      { title: '"Losing" — Joy Orbison', year: 2009 },
      { title: '"Patterns" — Mount Kimbie', year: 2009 },
    ]},

  // ── UK — HOT CREATIONS ───────────────────────────────────────────────────
  { id:'hot_creations', label:'Hot Creations', type:'label', genre:'house', era:2011, city:'London', country:'UK', bandcamp:'hotcreations',
    desc:'Hot Creations was founded in London in 2011 by Jamie Jones and Lee Foss. It became one of the defining labels of the tech-house revival, releasing records by Patrick Topping, Richy Ahmed, Eats Everything, wAFF, and Solardo. The label\'s sound — funky, driving, bass-heavy house — was closely associated with the DC-10 and fabric circuits in the early 2010s.',
    releases: [
      { title: '"We All Need Love" — Hot Natured', year: 2012 },
    ]},

  // ── UK — CROSSTOWN REBELS ────────────────────────────────────────────────
  { id:'crosstown_rebels', label:'Crosstown Rebels', type:'label', genre:'house', era:2003, city:'London', country:'UK',
    desc:'Crosstown Rebels was founded in London in 2003 by Damian Lazarus. It became one of the most internationally distributed underground house and techno labels of the 2000s and 2010s, releasing artists including Art Department, Rebolledo, Fur Coat, and Enzo Siragusa. Lazarus also created the Day Zero festival in Mexico under the Crosstown brand.',
    releases: [
      { title: '"Changes" — Damian Lazarus', year: 2007 },
    ]},

  // ── US — DIRTYBIRD RECORDS ───────────────────────────────────────────────
  { id:'dirtybird', label:'Dirtybird Records', type:'label', genre:'house', era:2005, city:'San Francisco', country:'US',
    desc:'Dirtybird Records was founded in San Francisco in 2005 by Claude VonStroke. It became one of the most commercially successful US underground house labels of the 2010s, known for a funky, irreverent, bass-heavy aesthetic. The label spawned the annual Dirtybird Campout festival and a roster including Justin Martin and Ardalan, and helped establish a distinctly American alternative to the European tech-house sound.',
    releases: [
