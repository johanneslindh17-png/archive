...
export default function App() {
  ...
  const newsStartRef     = useRef(null);  // Date.now() when current animation began
  ...
  useEffect(() => {
    ...
    const mkGrad = (id, color) => {
      ...
      [['0%','0'],['18%','0.55'],['50%','0.6'],['82%','0.55'],['100%','0']].forEach(([offset, op]) => {
        ...
        onMouseEnter={ev => {
          if (!isDim) {
            ...
            if (selfP && svgGRef.current) {
              ...
              selfGlowEl.setAttribute('rx', bw / 2 + 7);
              selfGlowEl.setAttribute('ry', BH / 2 + 2);
            ...
            EDGES.forEach(e => {
              ...
              if (p && nb && svgGRef.current) {
                ...
                glowEl.setAttribute('rx', bw / 2 + 5);
                glowEl.setAttribute('ry', BH / 2 + 1);
      ...
      <div className="nodebreadcrumb" style={themeStyle ? { background: themeStyle.surface, borderBottomColor: themeStyle.border } : undefined}>
        ...
        {!selected && !pinned && welcomeDone && newsItem && (
          <div
            ...
            style={{ animationPlayState: newsHovered ? 'paused' : 'running', animationDelay: newsDelayRef.current }}
