...
const TOUR_STEPS = [
  {
    id: 'map',
    title: 'A LIVING MAP',
    body: 'Welcome. Six decades of electronic music — 790+ artists, labels, clubs, and pivotal moments, all connected by documented lines of influence and lineage. Take your time.',
    getTarget: () => null,
    cardSide: 'center',
    onEnter: null,
    delay: 0,
        ...
        <div className="onboard-overlay">
          <div className="onboard-modal">
            ...
            <div className="onboard-pitch">
              Six decades of electronic music, mapped by the community itself. 790+ artists, labels, clubs, and pivotal moments — all connected by documented lines of influence, collaboration, and lineage. Explore freely, or let us show you around.
            </div>
